...
int MTLIKE[1024][1024]={0,0},n,a[1024]={0}, vertex, numOfEffect[1024] = {0}, b1[1024]={0}, oldNumKey1 = 0, oldNumKey2 = 0;
float MTWEIGHTED[1024][1024]={0,0},b[1024]={0}, oldThreshold = 0.0;
double LenPath[1024][1024] = {0,0};
string member[1024], member1[1024], member2[1024], affectionTop[1024],stringLenPath[1024],affectionTop1[1024],stringLenPath1[1024], fileIn, pathOldMatrix;
float LenSum[1024]={0};
...
MainWindow::MainWindow(const QString & m_fileName) {
    ...
    connect( kppTi,SIGNAL(clicked()), this, SLOT( slotKppTi() ) );

    connect( kppNoa,SIGNAL(clicked()), this, SLOT( slotKppNoa() ) );
...
//            this, SLOT(toolBoxAnalysisGeodesicsSelectChanged(int) ) );
    ...
    */
    ...
    dataDir= QDir::homePath() +QDir::separator() + "KPP-data" + QDir::separator() ;
    lastUsedDirPath = "KPP-initial-none";
    if (firstTime) {
        ...
        if ( !ourDir.exists() ) {
            ...
            QMessageBox::information(this, "KPP Data Directory",
                                 tr("KPP saves reports and files in the "
                                    "directory %1")
    ...
    statusMessage( tr("Welcome to Key Player Problems"));
...
void MainWindow::initActions(){
    ...
    */
    ...
    openTextEditorAct->setStatusTip(tr("Opens the KPP text editor."
                                       "You can copy/paste network data, save and then import them..."));
    openTextEditorAct->setWhatsThis(tr("Open Text Editor\n\nOpens the KPP text editor where you can copy paste network data, of any supported format, and save to a file. Then you can import that file to KPP..."));
    ...
    viewSociomatrixAct = new QAction(QIcon(":/images/sm.png"), tr("View Weighted Matrix"),  this);
    ...
    cProximityPrestigeAct
            ->setWhatsThis(
                tr("Proximity Prestige (PP) \n\n "
                   ...
                   "In essence, the formula KPP uses to calculate PP "
    ...
    */
    ...
    displayEdgesWeightNumbersAct->setChecked(true);
    ...
    */
    ...
    printDebugAct->setWhatsThis(tr("Enables or disable Debug Messages\n\nPrinting debug messages to strerr. Enabling has a significant cpu cost but lets you know what KPP is actually doing."));
    ...
    */
    ...
    helpApp->setWhatsThis(tr("Manual\n\nDisplays the documentation of KPP"));
    ...
    helpAboutApp->setStatusTip(tr("About"));
...
void MainWindow::initMenuBar() {
    ...
    networkMenu = menuBar()->addMenu(tr("&File"));
    //networkMenu -> addAction(fileNew);
    //networkMenu -> addAction(fileOpen);
    importSubMenu = new QMenu(tr("Open..."));
...
void MainWindow::initToolBox(){
     ...
     */
	QFont fontTimes10( "Times New Roman", 10, QFont::Bold);
	QFont fontArial9( "Arial", 9, QFont::Bold);
	QFont fontTimes13( "Times New Roman", 13, QFont::Bold);
    // create 4 buttons for the Edit groupbox
	

    kppTi= new QPushButton(QIcon(":/images/forward.png"),tr("&KPP-TI"));
    kppTi->setFocusPolicy(Qt::NoFocus);
    kppTi->setToolTip(
               tr("Key Player Problem - Total Influence")
                );
	//QFont fontBtn = kppTi->font();
	//fontBtn.setPointSize(16);
	
	kppTi->setFont( fontTimes10);

	status1 = new QLabel();
	status1->setText("");
	//startime1->setFont( f);
	status1->setMinimumWidth(80);
	//kppTi->setAutoFillBackground(true);
	//kppTi->setStyleSheet("background-color: #ededed; color: #000000");
	...
	*/
	...
	label1->setText(tr("<b>Number of KeyPlayers : <b>"));
	label1->setMinimumWidth(10);
	//label1->setTextFormat(Qt::black);
	numKey1= new QLineEdit();
    numKey1->setText("");
	numKey1->setMinimumWidth(50);
	//QString aa = numKey1->getTextMargins();
	//numKey1->append("Appending some text…");
	//numKey1->show();
	QLabel *label2 = new QLabel();
	label2->setStyleSheet("QLabel { background-color : darkblue; color : white; }");
	label2->setText("    Vertex of Key player");
	label2->setFont( fontTimes10);
	label2->setMinimumWidth(120);
	label2->setFixedHeight(20);

	QLabel *labelTotal = new QLabel();
	labelTotal->setStyleSheet("QLabel { background-color : darkblue; color : white; }");
	labelTotal->setText("        Total Influence");
	labelTotal->setFont( fontTimes10);
	labelTotal->setMinimumWidth(80);
	labelTotal->setFixedHeight(20);

	result11 = new QLabel();
	result11->setStyleSheet("QLabel { background-color : lightblue; color : black; }");
	result11->setText("");
	result11->setFont( fontTimes10);
	result11->setMinimumWidth(80);
	result11->setMinimumHeight(150);

	result12 = new QLabel();
	result12->setStyleSheet("QLabel { background-color : lightblue; color : black; }");
	result12->setText("");
	result12->setFont( fontTimes10);
	result12->setMinimumWidth(80);
	result12->setMinimumHeight(150);

	QLabel *startTimeLabel1 = new QLabel();
	startTimeLabel1->setText("<b>Start time :</b>");
	//startTimeLabel1->setFont( fontArial9);
	startTimeLabel1->setMinimumWidth(80);
	//startime1->setFixedHeight(160);

	startTime1 = new QLabel();
	startTime1->setText("");
	//startTime1->setFont( fontTimes10);
	startTime1->setMinimumWidth(80);
	startTime1->setFixedHeight(10);
	
	QLabel *endTimeLabel1 = new QLabel();
	endTimeLabel1->setText("<b>End time   :</b>");
	//endTimeLabel1->setFont( fontArial9);
	endTimeLabel1->setMinimumWidth(80);
	//startime1->setFixedHeight(160);

	endTime1 = new QLabel();
	endTime1->setText("");
	//endTime1->setFont( fontTimes10);
	endTime1->setMinimumWidth(80);
	endTime1->setFixedHeight(10);


	kppNoa= new QPushButton(QIcon(":/images/forward.png"),tr("KPP-NOA"));
    kppNoa->setFocusPolicy(Qt::NoFocus);
    kppNoa->setToolTip(
                tr("Key Player Problem - Number of Affected")
                );
	kppNoa->setFont( fontTimes10 );

	status2 = new QLabel();
	status2->setText("");
	status2->setMinimumWidth(80);

	QLabel *label3 = new QLabel();
	label3->setText(tr("<b>Number of KeyPlayers :</b>"));
	label3->setMinimumWidth(50);
	//label1->setTextFormat(Qt::black);
	numKey2= new QLineEdit();
    numKey2->setText("");
	numKey2->setMinimumWidth(50);

	QLabel *label5 = new QLabel();
	label5->setText(tr("<b>Threshold :<b>"));
	label5->setMinimumWidth(50);
	//label1->setTextFormat(Qt::black);

	threshold= new QLineEdit();
    threshold->setText("");
	threshold->setMinimumWidth(50);

	//QString aa = numKey1->getTextMargins();
	//numKey1->append("Appending some text…");
	//numKey1->show();

	QLabel *labelKey2 = new QLabel();
	labelKey2->setStyleSheet("QLabel { background-color : darkblue; color : white; }");
	labelKey2->setText("    Vertex of Key player");
	labelKey2->setFont( fontTimes10);
	labelKey2->setMinimumWidth(120);
	labelKey2->setFixedHeight(20);	

	QLabel *labelNumAffect = new QLabel();
	labelNumAffect->setStyleSheet("QLabel { background-color : darkblue; color : white; }");
	labelNumAffect->setText("  The number of Affected");
	labelNumAffect->setFont( fontTimes10);
	labelNumAffect->setMinimumWidth(80);
	labelNumAffect->setFixedHeight(20);

	result21 = new QLabel();
	result21->setStyleSheet("QLabel { background-color : lightblue; color : black; }");
	result21->setText("");
	result21->setFont( fontTimes10);
	result21->setMinimumWidth(80);
	result21->setMinimumHeight(150);

	result22 = new QLabel();
	result22->setStyleSheet("QLabel { background-color : lightblue; color : black; }");
	result22->setText("");
	result22->setFont( fontTimes10);
	result22->setMinimumWidth(80);
	result22->setMinimumHeight(150);

	QLabel *startTimeLabel2 = new QLabel();
	startTimeLabel2->setText("<b>Start time :</b>");
	//startTimeLabel1->setFont( fontArial9);
	startTimeLabel2->setMinimumWidth(80);
	//startime1->setFixedHeight(160);

	startTime2 = new QLabel();
	startTime2->setText("");
	//startTime1->setFont( fontTimes10);
	startTime2->setMinimumWidth(80);
	startTime2->setFixedHeight(10);
	
	QLabel *endTimeLabel2 = new QLabel();
	endTimeLabel2->setText("<b>End time   :</b>");
	//endTimeLabel1->setFont( fontArial9);
	endTimeLabel2->setMinimumWidth(80);
	//startime1->setFixedHeight(160);

	endTime2 = new QLabel();
	endTime2->setText("");
	//endTime1->setFont( fontTimes10);
	endTime2->setMinimumWidth(80);
	//endTime2->setFixedHeight(15);
	endTime2->setFixedHeight(10);

    //create a grid layout for these buttons
    QGridLayout *buttonsGrid = new QGridLayout;
    buttonsGrid->addWidget(kppTi, 0, 0);
	buttonsGrid->addWidget(status1, 0, 1);
	//kppTi->setMaximumWidth(80);
	//kppTi->setMinimumHeight(25);
	//kppTi->setMaximumHeight(30);
	
	//kppTi->move(100, 100);
	buttonsGrid->addWidget(label1, 1, 0);
	buttonsGrid->addWidget(numKey1, 1, 1);
	buttonsGrid->addWidget(startTimeLabel1, 2, 0);
	buttonsGrid->addWidget(startTime1, 2, 1);
	buttonsGrid->addWidget(endTimeLabel1, 3, 0);
	buttonsGrid->addWidget(endTime1, 3, 1);
	buttonsGrid->setSpacing(2);
    buttonsGrid->setMargin(3);
	//numKey1->setFixedHeight(25);
	//numKey1->setFixedWidth(60);
	QGridLayout *gridResult1 = new QGridLayout;
	gridResult1->addWidget(label2, 0, 0);
	gridResult1->addWidget(labelTotal, 0, 1);
	gridResult1->addWidget(result11, 1, 0);
	gridResult1->addWidget(result12, 1, 1);
	gridResult1->setSpacing(0);
	gridResult1->setMargin(0);
   
    //create a groupbox "Edit" - Inside, display the vertical layout of widgets
    QGroupBox *editGroupBox= new QGroupBox(tr("KPP-TI"));
    editGroupBox->setLayout(buttonsGrid);
    editGroupBox->setMaximumWidth(300);
	editGroupBox->setFixedHeight(100);
	//editGroupBox->setMaximumHeight(300);

	QGroupBox *editGroupBoxResult1= new QGroupBox(tr(""));
	editGroupBoxResult1->setLayout(gridResult1);
	//editGroupBox->setLayout(tableWidget);
	//editGroupBox->setFixedWidth(300);
	//editGroupBox->setFixedHeight(300);
    editGroupBoxResult1->setMaximumWidth(300);
    editGroupBoxResult1->setFixedHeight(180);
	//editGroupBoxResult1->setMaximumHeight(300);
	...
	*/
	...
	//result2 = new QLineEdit();
    //result2->setText("");
	//result2->setMinimumWidth(50);
	
	QGridLayout *buttonsGridNoa = new QGridLayout;
    buttonsGridNoa -> addWidget(kppNoa, 0, 0);
	buttonsGridNoa->addWidget(status2, 0, 1);
	

	buttonsGridNoa->addWidget(label3, 1, 0);
	buttonsGridNoa->addWidget(numKey2, 1, 1);
	buttonsGridNoa->addWidget(label5, 2, 0);
	buttonsGridNoa->addWidget(threshold, 2, 1);
	buttonsGridNoa->addWidget(startTimeLabel2, 3, 0);
	buttonsGridNoa->addWidget(startTime2, 3, 1);
	buttonsGridNoa->addWidget(endTimeLabel2, 4, 0);
	buttonsGridNoa->addWidget(endTime2, 4, 1);
	buttonsGridNoa->setSpacing(2);
    buttonsGridNoa->setMargin(3);

	QGridLayout *gridResult2 = new QGridLayout;
	gridResult2->addWidget(labelKey2, 0, 0);
	gridResult2->addWidget(labelNumAffect, 0, 1);
	gridResult2->addWidget(result21, 1, 0);
	gridResult2->addWidget(result22, 1, 1);
	gridResult2->setSpacing(0);
	gridResult2->setMargin(0);
	


    QGroupBox *thresholdBox= new QGroupBox(tr("KPP-NOA"));	
	thresholdBox->setBackgroundRole(QPalette::Background);
	thresholdBox->setLayout(buttonsGridNoa);
    thresholdBox->setMaximumWidth(300);
	thresholdBox->setFixedHeight(120);
	//analysisBox->setFixedWidth(300);
	//analysisBox->setFixedHeight(300);
	//analysisBox->setMinimumHeight(300);

	QGroupBox *editGroupBoxResult2= new QGroupBox(tr(""));
	editGroupBoxResult2->setLayout(gridResult2);
    editGroupBoxResult2->setMaximumWidth(300);
    editGroupBoxResult2->setFixedHeight(180);
	...
	controlTabVerticalLayout -> addWidget(editGroupBoxResult1);
	controlTabVerticalLayout -> addWidget(thresholdBox);
	controlTabVerticalLayout -> addWidget(editGroupBoxResult2);
    ...
    controlGroupBox->setMaximumWidth(310);
    controlGroupBox->setMinimumHeight(600);
	controlGroupBox->setMaximumHeight(700);
	//controlGroupBox->setFixedWidth(300);
    //controlGroupBox->setFixedHeight(600);
    controlGroupBox->setContentsMargins(0,0,0,0);
    toolBox->addTab(controlGroupBox, tr("Key Player Problems"));
    ...
    toolBox->setFixedWidth(310);
	toolBox->setFixedHeight(625);
    //toolBox->setStyleSheet("* { background-color:#ffffff}}");
...
/**
    Initializes the scene and its graphicsWidget, the main widget of KPP
*/
void MainWindow::initView() {
    ...
    graphicsWidget->setMinimumSize( (qreal)  ( this->width()-toolBox->sizeHint().width() -80 ) ,
                                    (qreal) ( this->height()-statusBar()->sizeHint().height() -toolBar->sizeHint().height() -menuBar()->sizeHint().height() -60 ) );
...
void MainWindow::initNet(){
    ...
    /** set window title **/
    setWindowTitle(tr("Key Player Problems"));
...
void MainWindow::slotInitVarible( bool flagPp) {
	// Init variable
	if (n>0)
	{
		vertex = 0;
...
QString MainWindow::getLastPath() {
    if ( lastUsedDirPath == "kpp-initial-none") {
        //lastUsedDirPath = QDir::homePath();
		lastUsedDirPath = "E:/DATA/Study/social network/Coding/BAO CAO/Source Code/data_test";
    }
...
void MainWindow::slotChooseFile() {
    ...
    if (firstTime && fileFormat == -500 ) {
        QMessageBox::information( this, "Key Player Problems",
                                  tr("Attention: \n")+
                                  tr("This menu option is more suitable for loading "
                                     "a network file in Adjacency matrix format (.txt).\n"),
                                  "OK", 0 );
        firstTime=false;
    }
    if ( fileFormat == -1 )
    ...
    switch (m_fileFormat){
    case 1:	//GraphML
        fileType_string = tr("Adjacency (*.txt);;All (*)");
        break;
    case 2: //Pajek
        fileType_string = tr("Pajek (*.net *.paj *.pajek);;All (*)");
        break;
    case 3: //Adjacency
        fileType_string = tr("Adjacency (*.json *.txt);;All (*)");
        break;
    case 4: //Dot
    ...
    if (checkSelectFileType) {
        ...
        if (m_fileName.endsWith(".graphml",Qt::CaseInsensitive ) ||
            ...
            fileFormat=m_fileFormat=2;
				 ...
				 m_fileName.endsWith(".json", Qt::CaseInsensitive)) {
    ...
    if (!m_fileName.isEmpty()) {
        if (m_fileFormat == -1) {
            QMessageBox::critical(this, "Unrecognized file extension", tr("Error! \n"
                                  "KPP supports the following network file"
                                 ...
                                 const int m_fileFormat )
{
    ...
    if ( loadGraphStatus )
    {
		...
		fileIn = fileNameNoPath.last().toStdString();
        setWindowTitle("Key Player Problems - "+fileNameNoPath.last());
        QString message=tr("Loaded network: ")+fileNameNoPath.last();
        statusMessage( message );
    }
    else {
        statusMessage( tr("Error loading requested file. Aborted."));
        QMessageBox::critical( this, "KPP",
                               tr("Error! \n")+
...
bool MainWindow::slotExportPNG(){
    ...
    p.drawText(5,10,"KPP: "+tempFileNameNoPath.last());
    p.end();
...
void MainWindow::slotViewNetworkFile(){
    ...
    if ( fileLoaded && !networkModified ) { //file network unmodified
        ...
        QMessageBox::critical(this, "Error",
                              tr("Empty network! \nPlease load a network file first or create and save a new one..."), "OK",0);
...
void MainWindow::slotViewAdjacencyMatrix(){
    if ( !fileLoaded && !networkModified) {
        QMessageBox::critical (this, "Error",
                               tr("Empty network! \nPlease load a network file!"), "OK",0);
    ...
    QString fn = dataDir + "KPP-report-adjacency-matrix.txt";
...
void MainWindow::slotRecreateDataSet (QString m_fileName) {
    ...
    if ( loadNetworkFile(dataDir+m_fileName, "UTF-8", m_fileFormat) ) {
        ...
        fileName=m_fileName;
        previous_fileName=fileName;
        setWindowTitle("KPP "+ VERSION +" - "+fileName);
                                       ...
                                       const bool diag)
{
    ...
    double threshold = 0.5;//log(newNodes)/newNodes;
...
void MainWindow::slotInvertAdjMatrix(){
    ...
    QString fn = dataDir + "Kpp-report-invert-adjacency-matrix.dat";
    ...
    TextEditor *ed = new TextEditor(fn);
    tempFileNameNoPath=fn.split( "/");
    ed->setWindowTitle(tr("View Weighted Matrix - ") + tempFileNameNoPath.last());
    ed->show();
...
void MainWindow::slotDistancesMatrix(){
    ...
    QString fn = dataDir + "kpp-report-distance-matrix.dat";
...
void MainWindow::slotGeodesicsMatrix(){
    ...
    QString fn = dataDir + "kpp-report-sigmas-matrix.dat";
...
void MainWindow::slotEccentricity(){
    ...
    QString fn = dataDir + "kpp-report-eccentricity.dat";
...
void MainWindow::slotWalksOfGivenLength(){
    ...
    QString fn = dataDir + "kpp-report-number-of-walks.dat";
     bool ok=false;
    createProgressBar();
...
void MainWindow::slotTotalWalks(){
    ...
    QString fn = dataDir + "kpp-report-total-number-of-walks.dat";
    createProgressBar();
...
void MainWindow::slotReachabilityMatrix(){
    ...
    QString fn = dataDir + "kpp-report-reachability-matrix.dat";
...
void MainWindow::slotCliqueCensus(){
    ...
    QString fn = dataDir + "kpp-report-clique-census.dat";
...
void MainWindow::slotClusteringCoefficient (){
    ...
    QString fn = dataDir + "kpp-report-clustering-coefficients.dat";
    bool considerWeights=true;
...
void MainWindow::slotTriadCensus() {
    ...
    QString fn = dataDir + "kpp-report-triad-census.dat";
    bool considerWeights=true;
...
void MainWindow::slotCentralityDegree(){
    ...
    QString fn = dataDir + "kpp-report-centrality-out-degree.dat";
...
void MainWindow::slotCentralityCloseness(){
    ...
    QString fn = dataDir + "kpp-report-centrality_closeness.dat";
...
void MainWindow::slotCentralityClosenessInfluenceRange(){
    ...
    QString fn = dataDir + "kpp-report-centrality_closeness_influence_range.dat";
...
void MainWindow::slotCentralityBetweenness(){
    ...
    QString fn = dataDir + "kpp-report-centrality_betweenness.dat";
...
void MainWindow::slotPrestigeDegree(){
    ...
    QString fn = dataDir + "kpp-report-degree-prestige.dat";
...
void MainWindow::slotPrestigePageRank(){
    ...
    QString fn = dataDir + "kpp-report-prestige_pagerank.dat";
...
void MainWindow::slotPrestigeProximity(){
    ...
    QString fn = dataDir + "kpp-report-centrality_proximity_prestige.dat";
...
void MainWindow::slotCentralityInformation(){
    ...
    QString fn = dataDir + "kpp-report-centrality_information.dat";
    statusMessage(  QString(tr(" Please wait...")));
...
void MainWindow::slotCentralityStress(){
    ...
    QString fn = dataDir + "kpp-report-centrality_stress.dat";
...
void MainWindow::slotCentralityPower(){
    ...
    QString fn = dataDir + "kpp-report-centrality_power.dat";
...
void MainWindow::slotCentralityEccentricity(){
    ...
    QString fn = dataDir + "kpp-report-centrality_eccentricity.dat";
...
void MainWindow::createTips(){
    ...
    tips+=tr("KPP can save the positions of the nodes in a network, if you save it in Pajek/GraphML format.");
    ...
    tips+=tr("All basic operations of KPP are available from the dock on the left, or by right-clicking on a node or an Edge.");
...
void MainWindow::slotHelp(){
    ...
    if ( d.exists("manual.html") ) {
        ...
        // MacOS: assumes manual dir in kpp.app/Contents/
        ...
        if ( !manualFound && d.cd("/usr/local/share/doc/kpp/") ) {			//for compile installation
        ...
        if (!manualFound && d.cd("/usr/share/doc/kpp/") ) {     //for Debian Ubuntu
            if (d.exists("manual/")) d.cd("manual/");
            if ( d.exists("manual.html") ) {
                helpPath=d.filePath("manual.html");
                manualFound = true;
                ...
                qDebug("help file does not exist in /usr/share/doc/kpp/.");
                manualFound = false;
            }
        }
        if ( !manualFound && d.cd("/usr/share/doc/packages/kpp/") ) {  //for opensuse file hierarchy
            if (d.exists("manual/"))
                d.cd("manual/");
            if ( d.exists("manual.html") ) {
                helpPath=d.filePath("manual.html");
        ...
        QString fedoraPath = "/usr/share/doc/kpp-" + VERSION;
...
void MainWindow::slotHelpAbout(){
    QMessageBox::about( this, "About",
						"<p>Master's Thesis</p>"
						"<p>Key player Problems v1.0</p>"
                        "<p>Huynh Thanh Viet</p>"
                      );
}
...
void MainWindow::slotAboutQt(){
    QMessageBox::aboutQt(this, "About Qt - KPP");
}
...
void writeMT(float mtg[1024], int top)
{
	string path="Result_keyplayers_" + fileIn;
	ofstream write (path);
	//write<<n<<"\n";
	write<<"The list of "<<top<<" the vertexes have the total influence as maximum in the network: "<<endl;
	for(int i=1;i<=n;i++)
	{
		a[i]=i;
		b[i]=mtg[i];
	...
	for(int i=1;i<=top;i++)
	{
		write<<"The total influence "<<a[i]<< "(" <<member[i] <<") : "<<b[i];
		write<<"\n";
		write<<"This vertex affects to: "<<"\n";
		write<<affectionTop[i]<<"\n";
		write<<"The influence to every vertexes:\n";
		write<<stringLenPath[i]<<"\n";
	}
}

void writeMT2(int mtg[1024], int top, float threshold )
{
	string tempThres = FloatToString(threshold);
	string path="Result_keyplayers_threshold_" + tempThres + "_" + fileIn;
	ofstream write (path);
	//write<<n<<"\n";
	write<<"The list of "<<top<<" the vertexes have the influence as maximum in the network: "<<endl;
	for(int i=1;i<=n;i++)
	{
		a[i]=i;
		b1[i]=mtg[i];
	...
	for(int i=1;i<=top;i++)
	{
		write<<"The number of affected from vertex "<<a[i]<<"("<<member1[i]<<") passed the threshold "<<threshold<<" : "<<b1[i];
		write<<"\n";
		write<<"This vertex affects to other vertexes that passed the threshold: "<<"\n";
...
void MainWindow::slotKppTi()
{
	//if ( m_sPp1Done == false )
	{
		if (fileName.toStdString() == "")
		{
			QMessageBox::critical (this, "Error",tr("Please input the Adjacency Matrix!"), "OK",0);
		}
		else
		{
			int top = 0;
			QString temptop = numKey1->text();
			top = temptop.toInt();
			float l_threshold = 0.0;
			bool flagCalculate = false, flagOldMt = false;
			if (fileName.toStdString() != pathOldMatrix)
			{
				flagCalculate = true;
				flagOldMt = false;
			}
			else if (fileName.toStdString() == pathOldMatrix)
			{	
				if ( oldNumKey1 != top )
				{
					flagCalculate = true;
			...
			{
				//slotInitVarible(false);
				time_t rawtime;
				time(&rawtime);	
				QString tempTime = (QString)ctime(&rawtime);
				status1->setText("                           Processing...");
				status1->repaint();
				startTime1->setText(tempTime);
				startTime1->repaint();
				if ( m_sDone == false)
				{
				...
				if ( ProcessFiles( top, l_threshold, false ) == true )
				{
					...
					//CString m_sResult;
					QString aResult, bResult, aStr, bStr;
					for(int i=1;i<=top;i++)
					{
					...
					result11->setText(aResult);
					result12->setText(bResult);
					if ( top <=7 )
					{
						QFont fontTimes13( "Times New Roman", 13, QFont::Bold);
						result11->setFont(fontTimes13);
						result12->setFont(fontTimes13);
					}
					else if ( top > 7 && top <= 10)
					{
						QFont fontTimes10( "Times New Roman", 10, QFont::Bold);
						result11->setFont(fontTimes10);
						result12->setFont(fontTimes10);
					...
					{
						QFont fontTimes8( "Times New Roman", 8, QFont::Bold);
						result11->setFont(fontTimes8);
						result12->setFont(fontTimes8);
					}
					time(&rawtime);
					QString tempTime1 = (QString)ctime(&rawtime);
					endTime1->setText(tempTime1);
					m_sDone = true;
					m_sPp1Done = true;
			...
			{
				QMessageBox::critical(0,"Error",tr("Please change the Number of Key Players or click to New Button to continue with another matrix!"), "OK", 0);	
			}
		}
	}
	//else
	{
		//QMessageBox::critical(0,"Error",tr("Already done!\nPlease click to New Button to continue with another matrix!"), "OK", 0);
	}
}

void MainWindow::slotKppNoa() 
{
    //if ( m_sPp2Done == false )
	{
		...
		{
			int top = 0;
			QString temptop = numKey2->text();
			top = temptop.toInt();

			float l_threshold = 0.0;
			QString tempThreshold = threshold->text();
			l_threshold = tempThreshold.toFloat();
			...
			{	
				if ( oldNumKey2 != top || oldThreshold != l_threshold )
				{
					flagCalculate = true;
				}
				else
			...
			if (flagCalculate == true)
			{
				...
				if ( ProcessFiles(top, l_threshold, true ) == true)
				{
					handlerResult(l_threshold, true, m_sDone);
					writeMT2(numOfEffect, top, l_threshold);
					oldNumKey2 = top;
					oldThreshold = l_threshold;
					QString aResult, bResult;
					for(int i=1;i<=top;i++)
					{
						QString aStr = QString::number(a[i]);
						QString bStr = QString::number(b1[i]);
						aResult += "             "+ aStr + "\n";
						bResult += "               "+ bStr + "\n";
					}
					result21->setText(aResult);
					result22->setText(bResult);
					if ( top <=7 )
					{
						QFont fontTimes13( "Times New Roman", 13, QFont::Bold);
						result21->setFont(fontTimes13);
						result22->setFont(fontTimes13);
					}
					else if ( top > 7 && top <= 10)
					{
						QFont fontTimes10( "Times New Roman", 10, QFont::Bold);
					...
					{
						QFont fontTimes8( "Times New Roman", 8, QFont::Bold);
						result21->setFont(fontTimes8);
						result22->setFont(fontTimes8);
					}
					time(&rawtime);
					QString tempTime1 = (QString)ctime(&rawtime);
					endTime2->setText(tempTime1);
					m_sDone = true;
					m_sPp2Done = true;
			...
			{
				QMessageBox::critical(0,"Error",tr("Please change the Number of Key Players, Threshold or click to New Button to continue with another matrix!"), "OK", 0);	
			}
		}
	}
}

bool MainWindow::ProcessFiles(int top, float threshold, bool flagPp )
{	
	if (top < 1 || top > n) 
	{
		QMessageBox::critical (this, "Error",tr("Please check the number of Key players!"), "OK",0);
		return false;
	}
	if ( flagPp == true )
	{
		...
		{
			QMessageBox::critical (this, "Error",tr("Please check the value of threshold!"), "OK",0);
			return false;
		}
	}
	return true;
