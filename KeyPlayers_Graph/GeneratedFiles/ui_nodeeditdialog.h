...
public:
    ...
    void retranslateUi(QDialog *NodeEditDialog)
    {
        ...
        label->setText(QApplication::translate("NodeEditDialog", "Node label ", 0));
        label_3->setText(QApplication::translate("NodeEditDialog", "Node value (disabled)", 0));
        label_5->setText(QApplication::translate("NodeEditDialog", "Node shape", 0));
        ...
        label_4->setText(QApplication::translate("NodeEditDialog", "Node color (click the button to select)", 0));
        colorButton->setText(QApplication::translate("NodeEditDialog", "...", 0));
        label_2->setText(QApplication::translate("NodeEditDialog", "Node size (default 8)", 0));
    } // retranslateUi
