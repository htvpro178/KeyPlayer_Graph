...
public slots:
	...
	void createEdge1 (int, int, float, float, QString, int, bool, bool);	//GW and Parser.
...
signals:
	...
	void drawEdge1(int, int, float, float, bool, bool, QString, bool);	//call GW to draw an edge
